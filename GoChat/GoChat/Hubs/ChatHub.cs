...
namespace GoChat.Hubs
{
    ...
    public class ChatHub : Hub
    {
       ...
       public async void Send(string roomName, string message)
       {
       ...
       public async void SendPrivate(string message)
       {
           ...
           if (_ConnectionsMap.TryGetValue(receiver, out userId))
           {
               ...
               // Send the message
               await Clients.Client(userId).SendAsync("Send",messageViewModel);
